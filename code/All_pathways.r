...
Inscore <- AddModuleScore(LIHC,
                          features = hsa04979,
                          ctrl = 10,
                          name = "hsa04979")
LIHC@meta.data$hsa04979  <- as.numeric(Inscore$hsa049791)
...
Inscore <- AddModuleScore(LIHC,
                          ...
                          ctrl = 10,
                          name = "hsa05205")
LIHC@meta.data$hsa05205  <- as.numeric(Inscore$hsa052051)
...
Inscore <- AddModuleScore(LIHC,
                          ...
                          ctrl = 10,
                          name = "hsa00190")
LIHC@meta.data$hsa00190  <- as.numeric(Inscore$hsa001901)
...
Inscore <- AddModuleScore(LIHC,
                          ...
                          ctrl = 10,
                          name = "hsa04668")
LIHC@meta.data$hsa04668  <- as.numeric(Inscore$hsa046681)
...
Inscore <- AddModuleScore(LIHC,
                          ...
                          ctrl = 10,
                          name = "hsa05208")
LIHC@meta.data$hsa05208  <- as.numeric(Inscore$hsa052081)
...
Inscore <- AddModuleScore(LIHC,
                          ...
                          ctrl = 10,
                          name = "hsa05200")
LIHC@meta.data$hsa05200  <- as.numeric(Inscore$hsa052001)
...
Inscore <- AddModuleScore(LIHC,
                          ...
                          ctrl = 10,
                          name = "hsa04510")
LIHC@meta.data$hsa04510  <- as.numeric(Inscore$hsa045101)
...
Inscore <- AddModuleScore(LIHC,
                          ...
                          ctrl = 10,
                          name = "hsa04932")
LIHC@meta.data$hsa04932  <- as.numeric(Inscore$hsa049321)
...
Inscore <- AddModuleScore(LIHC,
                          ...
                          ctrl = 10,
                          name = "hsa04151")
LIHC@meta.data$hsa04151  <- as.numeric(Inscore$hsa041511)
...
Inscore <- AddModuleScore(LIHC,
                          ...
                          ctrl = 10,
                          name = "hsa04610")
LIHC@meta.data$hsa04610  <- as.numeric(Inscore$hsa046101)
...
Inscore <- AddModuleScore(LIHC,
                          ...
                          ctrl = 10,
                          name = "hsa04512")
LIHC@meta.data$hsa04512 <- as.numeric(Inscore$hsa045121)
...
Inscore <- AddModuleScore(LIHC,
                          ...
                          ctrl = 10,
                          name = "hsa04066")
LIHC@meta.data$hsa04066  <- as.numeric(Inscore$hsa040661)


mydata1<- FetchData(LIHC,vars = c("Type","sample","hsa05200", "hsa04510", "hsa05208", "hsa04932", "hsa04151", "hsa05205", "hsa04610", "hsa00190", "hsa04512", "hsa04979", "hsa04066", "hsa04668"))
